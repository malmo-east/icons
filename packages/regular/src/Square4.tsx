...
const SvgSquare4 = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
        <path d="M296 272h-8v-50.7c0-13.25-10.75-24-24-24s-24 10.75-24 24V272h-65.5l47.58-110.5c5.234-12.19-.375-26.31-12.56-31.53-12.22-5.27-26.32.33-32.42 12.53l-62 144c-3.188 7.438-2.438 15.94 2 22.69S129.9 320 138 320h102v40c0 13.25 10.75 24 24 24s24-10.7 24-24v-40h8c13.3 0 24-10.7 24-24s-10.7-24-24-24zm88-240H64C28.65 32 0 60.65 0 96v320c0 35.35 28.65 64 64 64h320c35.35 0 64-28.65 64-64V96c0-35.35-28.7-64-64-64zm16 384c0 8.822-7.178 16-16 16H64c-8.822 0-16-7.178-16-16V96c0-8.822 7.178-16 16-16h320c8.822 0 16 7.178 16 16v320z" />
    </svg>
);
