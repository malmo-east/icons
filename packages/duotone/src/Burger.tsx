...
const SvgBurger = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="burger_svg__fa-primary"
      d="M481.9 270.1c9 9 14.1 21.2 14.1 33.9s-5.1 24.9-14.1 33.9S460.7 352 448 352H64c-12.73 0-24.94-5.1-33.94-14.1-9-9-14.06-21.2-14.06-33.9s5.06-24.9 14.06-33.9S51.27 256 64 256h384c12.7 0 24.9 5.1 33.9 14.1z"
    />
    <path
