...
const SvgMapLocationDot = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" {...props}>
    <path
      className="map-location-dot_svg__fa-primary"
      d="M273.2 311.1C241.1 271.9 168 174.6 168 120 168 53.73 221.7 0 288 0s120 53.73 120 120c0 54.6-73.1 151.9-105.2 191.1-7.7 10.5-21.9 10.5-29.6 0zM288 152c22.1 0 40-17.9 40-40 0-22.09-17.9-40-40-40s-40 17.91-40 40c0 22.1 17.9 40 40 40z"
    />
    <path
