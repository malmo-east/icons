...
const SvgFaceSmileUpsideDown = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="face-smile-upside-down_svg__fa-primary"
      d="M207.6 304c0 17.7-14.3 32-32 32-18.5 0-32-14.3-32-32s13.5-32 32-32c17.7 0 32 14.3 32 32zm160 0c0 17.7-14.3 32-32 32-18.5 0-32-14.3-32-32s13.5-32 32-32c17.7 0 32 14.3 32 32z"
    />
    <path
