...
const SvgFileCircleQuestion = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" {...props}>
    <path
      className="file-circle-question_svg__fa-primary"
      d="M224 160V0l160 160H224zm64 208c0-79.5 64.5-144 144-144s144 64.5 144 144-64.5 144-144 144-144-64.5-144-144zm144 96c13.3 0 24-10.7 24-24s-10.7-24-24-24-24 10.7-24 24 10.7 24 24 24zm-64-136c0 8.8 7.2 16 16 16s16-7.2 16-16v-6.4c0-5.3 4.3-9.6 9.6-9.6h40.5c7.7 0 13.9 6.2 13.9 13.9 0 5.2-2.9 9.9-7.4 12.4l-32 16.8c-5.3 2.8-8.6 8.2-8.6 14.1V384c0 8.8 7.2 16 16 16s16-7.2 16-16v-5.1l23.5-12.3c15.1-8 24.5-24.5 24.5-40.7 0-25.3-20.6-45.9-45.9-45.9h-40.5c-23 0-41.6 18.6-41.6 41.6v6.4z"
    />
    <path
