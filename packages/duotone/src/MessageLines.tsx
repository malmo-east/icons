...
const SvgMessageLines = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="message-lines_svg__fa-primary"
      d="M360 144H152c-13.2 0-24 10.8-24 24s10.8 24 24 24h208c13.3 0 24-10.7 24-24s-10.7-24-24-24zm-96 96H152c-13.2 0-24 10.8-24 24s10.8 24 24 24h112c13.3 0 24-10.7 24-24s-10.7-24-24-24z"
    />
    <path
