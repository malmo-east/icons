...
const SvgHeadSideHeart = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="head-side-heart_svg__fa-primary"
      d="m330.4 198.3-83 85.6c-5.387 5.504-13.95 5.504-19.34 0l-82.96-85.6c-24.11-25.02-22.64-66.17 4.285-89.19 23.5-20.02 58.39-16.39 79.81 5.754l8.445 8.754L246 114.9c21.55-22.14 56.56-25.77 79.93-5.754C353 132.1 354.5 173.3 330.4 198.3z"
    />
    <path
...
export default SvgHeadSideHeart;
