...
const SvgFireFlameSimple = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" {...props}>
    <path
      className="fire-flame-simple_svg__fa-primary"
      d="M192 432c-56.5 0-96-37.76-96-91.74 0-12.47 4.207-55.32 83.87-143 6.314-6.953 17.95-6.953 24.26 0C283.8 284.9 288 327.8 288 340.3c0 53.9-39.5 91.7-96 91.7z"
    />
    <path
