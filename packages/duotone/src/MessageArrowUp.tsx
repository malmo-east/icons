...
const SvgMessageArrowUp = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="message-arrow-up_svg__fa-primary"
      d="M350.6 224.1c-4.7 5.6-10.8 7.9-16.9 7.9a24 24 0 0 1-16.97-7.031l-39.03-39.03V288c0 13.25-10.75 24-24 24s-24-10.75-24-24V185.9l-39.1 38.2c-9.375 9.375-24.56 9.375-33.94 0s-9.375-24.56 0-33.94l80-80c9.375-9.375 24.56-9.375 33.94 0l80 80c8.5 10.24 8.5 25.44 0 33.94z"
    />
    <path
