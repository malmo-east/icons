...
const SvgCloudArrowDown = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" {...props}>
    <path
      className="cloud-arrow-down_svg__fa-primary"
      d="m256.1 279 39.9 39.1V184c0-13.3 10.7-24 24-24s24 10.7 24 24v134.1l39-39.1c9.4-9.3 24.6-9.3 33.1 0 10.2 9.4 10.2 24.6 0 33.1l-80 80c-8.5 10.2-23.7 10.2-33.1 0l-80-80c-9.3-8.5-9.3-23.7 0-33.1 9.4-9.3 24.6-9.3 33.1 0z"
    />
    <path
