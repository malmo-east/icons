...
const SvgDial = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" {...props}>
    <path
      className="dial_svg__fa-primary"
      d="M276.1 276c-5.4 6.3-5.4 16.4 0 22.6 7.1 6.3 17.2 6.3 23.5 0l112.6-112.5c51.5 62.8 47.9 155.7-10.8 214.4-62.5 61.6-163.8 61.6-226.3 0-62.4-63.4-62.4-163.8 0-226.3 58.7-58.7 151.6-62.3 214.4-10.8L276.1 276z"
    />
    <path
