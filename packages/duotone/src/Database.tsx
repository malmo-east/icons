...
const SvgDatabase = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
    <path
      ...
      d="M0 186.1V128c0 44.2 100.3 80 224 80s224-35.8 224-80v58.1c-14.9 11.7-34.9 21.2-54.8 28.6-44.9 16-104.7 25.3-169.2 25.3-64.5 0-124.34-9.3-169.15-25.3-20.83-7.4-39.92-16.9-54.85-28.6zm0 160V288c0 44.2 100.3 80 224 80s224-35.8 224-80v58.1c-14.9 11.7-34.9 21.2-54.8 28.6-44.9 16-104.7 25.3-169.2 25.3-64.5 0-124.34-9.3-169.15-25.3-20.83-7.4-39.92-16.9-54.85-28.6z"
    />
    <path
