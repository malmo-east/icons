...
const SvgMessageExclamation = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="message-exclamation_svg__fa-primary"
      d="M256 240c13.25 0 24-10.75 24-24V104c0-13.25-10.75-24-24-24s-24 10.75-24 24v112c0 13.3 10.8 24 24 24zm0 32c-17.67 0-32 14.33-32 32s14.33 32 32 32 32-14.33 32-32c0-17.7-14.3-32-32-32z"
    />
    <path
