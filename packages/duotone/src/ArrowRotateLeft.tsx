...
const SvgArrowRotateLeft = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="arrow-rotate-left_svg__fa-primary"
      d="M192 224H48c-17.67 0-32-14.31-32-32V48c0-17.69 14.33-32 32-32s32 14.31 32 32v112h112c17.67 0 32 14.31 32 32s-14.3 32-32 32z"
    />
    <path
      d="M480 256c0 123.4-100.5 223.9-223.9 223.9-48.86 0-95.19-15.58-134.2-44.86-14.14-10.59-17-30.66-6.391-44.81 10.61-14.09 30.69-16.97 44.8-6.375 27.84 20.91 61 31.94 95.89 31.94C344.3 415.8 416 344.1 416 256S344.33 96.2 256.2 96.2c-50.3.02-97.6 24.1-127.6 63.8H80v-41.8c42.1-53.62 106.1-86.09 176.1-86.09C379.5 32.11 480 132.6 480 256z"
      style={{
        opacity: 0.4,
      }}
    />
