...
const SvgPhoneArrowDownLeft = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="phone-arrow-down-left_svg__fa-primary"
      d="M502.6 54.63 397.3 160H416c17.67 0 32 14.33 32 32s-14.33 32-32 32h-96c-17.67 0-32-14.33-32-32V96c0-17.67 14.33-32 32-32s32 14.33 32 32v18.75L457.4 9.35c12.5-12.5 32.75-12.5 45.25 0s12.45 32.78-.05 45.28z"
    />
    <path
