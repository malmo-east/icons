...
const SvgTreeDecorated = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      ...
      d="M311.1 160c0-13.25-10.75-24-23.1-24s-23.1 10.75-23.1 24 10.75 24 23.1 24 23.1-10.7 23.1-24zm8.9 232c-13.25 0-23.1 10.75-23.1 24s10.75 24 23.1 24 23.1-10.75 23.1-24-9.9-24-23.1-24z"
    />
    <path
