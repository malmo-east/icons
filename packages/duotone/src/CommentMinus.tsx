...
const SvgCommentMinus = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="comment-minus_svg__fa-primary"
      d="M360 240c0 13.26-10.74 23.1-23.1 23.1H175.1c-12.4 0-23.1-9.8-23.1-23.1 0-13.26 10.74-23.1 23.1-23.1h160c14.2-.9 24.9 9.8 24.9 23.1z"
    />
    <path
