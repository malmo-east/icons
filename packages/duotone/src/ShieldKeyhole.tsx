...
const SvgShieldKeyhole = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="shield-keyhole_svg__fa-primary"
      d="M280 258.4V328c0 13.25-10.75 24-24 24s-24-10.75-24-24v-69.6c-18.9-9-32-28.1-32-50.4 0-30.93 25.07-56 56-56s56 25.07 56 56c0 22.3-13.1 41.4-32 50.4z"
    />
    <path
