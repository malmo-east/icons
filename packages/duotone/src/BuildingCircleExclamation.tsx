...
const SvgBuildingCircleExclamation = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" {...props}>
    <path
      className="building-circle-exclamation_svg__fa-primary"
...
export default SvgBuildingCircleExclamation;
