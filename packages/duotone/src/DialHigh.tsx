...
const SvgDialHigh = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" {...props}>
    <path
      className="dial-high_svg__fa-primary"
      d="M288.4 271.6c-8.8 0-16 7.2-16 16s7.2 16 16 16h159.2c-8 80.9-76.2 144-159.2 144-88.4 0-160-72.5-160-160 0-88.4 71.6-160 160-160 83 0 151.2 63.1 159.2 144H288.4z"
    />
    <path
