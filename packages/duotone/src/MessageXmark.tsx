...
const SvgMessageXmark = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="message-xmark_svg__fa-primary"
      d="M175 288.1c9.373 9.371 24.56 9.379 33.94 0L256 241.9l47.03 47.03c9.373 9.371 24.56 9.379 33.94 0 9.375-9.375 9.375-24.56 0-33.94L289.9 208l47.03-47.03c9.375-9.375 9.375-24.56 0-33.94s-24.56-9.375-33.94 0L256 174.1 208.1 127c-9.375-9.375-24.56-9.375-33.94 0s-9.375 24.56 0 33.94L222.1 208 175 255c-9.3 9.4-9.3 24.6 0 33.1z"
    />
    <path
