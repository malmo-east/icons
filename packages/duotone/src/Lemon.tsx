...
const SvgLemon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
    <path
      ...
      d="M211.9 127.5c-44.3 11.2-105.2 72.1-116.37 116.4-1.84 7.3-8.34 11.2-16.43 11.2-1.281 0-2.594-.156-3.906-.469C67.53 253.4 62.34 244.7 64.47 236.1c14.16-56.28 83.31-125.4 139.6-139.6 8.656-2.031 17.25 3.062 19.44 11.62 2.19 8.58-3.01 17.18-11.61 19.38z"
    />
    <path
