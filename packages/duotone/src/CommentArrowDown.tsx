...
const SvgCommentArrowDown = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="comment-arrow-down_svg__fa-primary"
      d="m352.1 256.1-80 80c-9.375 9.375-24.56 9.375-33.94 0l-80-80c-9.375-9.375-9.375-24.56 0-33.94C163.7 218.3 169.8 216 176 216s12.28 2.344 16.97 7.031L232 262.1V160c0-13.25 10.75-24 24-24s24 10.8 24 24v102.1l39.03-39.03c9.375-9.375 24.56-9.375 33.94 0s9.33 24.53-.87 33.03z"
    />
    <path
