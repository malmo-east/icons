...
const SvgMessageCheck = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="message-check_svg__fa-primary"
      d="m347.7 167.6-96 112c-4.3 5.1-10.6 8.1-17.3 7.5h-.9a24.04 24.04 0 0 1-16.97-7.031l-48-48c-9.375-9.375-9.375-24.56 0-33.94s24.56-9.375 33.94 0l29.69 29.69 79.13-92.34c8.656-10.06 23.81-11.19 33.84-2.594C355.2 142.4 356.3 157.5 347.7 167.6z"
    />
    <path
