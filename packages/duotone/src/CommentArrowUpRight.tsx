...
const SvgCommentArrowUpRight = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="comment-arrow-up-right_svg__fa-primary"
      d="M312 144H200c-13.2 0-24 10.8-24 24s10.8 24 24 24h54.06L167 279c-9.375 9.375-9.375 24.56 0 33.94 9.373 9.375 24.56 9.381 33.94 0L288 225.9V280c0 13.25 10.75 24 24 24s24-10.75 24-24V168c0-13.2-10.7-24-24-24z"
    />
    <path
