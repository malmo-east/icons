...
const SvgSquareV = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
    <path
      className="square-v_svg__fa-primary"
      d="M338.7 130.5c-11.86-5.891-26.27-1.125-32.2 10.73L224 306.3l-82.5-165c-6-11.9-20.3-16.7-32.2-10.8-11.89 6-16.69 20.4-10.77 32.2l104 208C206.6 378.9 214.9 384 224 384s17.41-5.141 21.47-13.27l104-208c5.93-11.83 1.13-26.23-10.77-32.23z"
    />
    <path
