...
const SvgHandHoldingDroplet = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" {...props}>
    <path
      className="hand-holding-droplet_svg__fa-primary"
      d="M287.1 256c53 0 95.1-42.13 95.1-93.1 0-40-57.12-120.8-83.25-155.6-6.375-8.5-19.12-8.5-25.5 0C249.1 41.25 191.1 122 191.1 162c0 51.9 43 94 96 94z"
    />
    <path
...
export default SvgHandHoldingDroplet;
