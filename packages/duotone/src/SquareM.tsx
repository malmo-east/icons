...
const SvgSquareM = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
    <path
      className="square-m_svg__fa-primary"
      d="M335.4 129.2c-9.953-3.25-20.75.313-26.84 8.781L224 255l-84.5-117.9c-6.1-7.6-17-11.2-26.9-7.9-9.9 3.2-16.6 12.4-16.6 22.8v208c0 13.3 10.8 24 24 24s24-10.75 24-24V226.2l60.55 83.83c9.031 12.5 29.88 12.5 38.91 0L304 226.2V360c0 13.25 10.75 24 24 24s24-10.7 24-24V152c0-10.4-6.7-19.6-16.6-22.8z"
    />
    <path
