...
const SvgCommentArrowUp = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="comment-arrow-up_svg__fa-primary"
      d="M352.1 256.1c-3.8 5.6-9.9 7.9-16.1 7.9s-12.28-2.344-16.97-7.031L280 217.9V320c0 13.25-10.75 24-24 24s-24-10.7-24-24V217.9l-39.9 38.2c-9.375 9.375-24.56 9.375-33.94 0s-9.375-24.56 0-33.94l80-80c9.375-9.375 24.56-9.375 33.94 0l80 80c10.2 10.24 10.2 25.44 0 33.94z"
    />
    <path
