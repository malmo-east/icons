...
const SvgBadgeCheck = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      ...
      d="M352.1 191c10.2 9.4 10.2 24.6 0 33.1l-112 112c-8.5 10.2-23.7 10.2-33.1 0l-56-56c-9.3-8.5-9.3-23.7 0-33.1 9.4-9.3 24.6-9.3 33.1 0l39.9 39.1 95-95.1c9.4-9.3 24.6-9.3 33.1 0z"
    />
    <path
