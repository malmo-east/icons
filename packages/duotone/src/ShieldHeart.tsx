...
const SvgShieldHeart = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="shield-heart_svg__fa-primary"
      d="m364.2 263.6-98.1 99.8c-5.3 6.1-14.9 6.1-21.9 0l-96.4-99.8c-28-28.9-26.3-77 5.2-104.1 27.2-23.7 68.4-19.3 92.9 7l10.5 9.6 9.7-9.6c25.4-26.3 65.7-30.7 92-7 32.4 27.1 34.1 75.2 6.1 104.1z"
    />
    <path
