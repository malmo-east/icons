...
const SvgSquareUp = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
    <path
      className="square-up_svg__fa-primary"
      d="M350.8 246.1c-2.5 6-8.3 9.9-14.8 9.9h-64v104c0 13.25-10.75 24-24 24h-48c-13.25 0-24-10.75-24-24V256h-64c-6.5 0-12.31-3.9-14.78-9.9-2.49-6-1.11-12.8 3.48-17.4l112-112c6.248-6.248 16.38-6.248 22.62 0l112 112c4.58 4.6 5.98 11.4 3.48 17.4z"
    />
    <path
