...
const SvgMessagePlus = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="message-plus_svg__fa-primary"
      d="M360 208c0 13.26-10.74 23.1-23.1 23.1h-56V288c-1.8 13.3-11.6 24-24.9 24-13.27 0-23.1-10.74-23.1-23.1v-57.8h-57.8c-12.4 0-23.1-9.8-23.1-23.1 0-13.26 10.74-23.1 23.1-23.1h56v-57.8c.9-12.4 11.6-23.1 24.9-23.1s23.1 10.74 23.1 23.1V184h56c14.2 0 24.9 10.7 24.9 24z"
    />
    <path
