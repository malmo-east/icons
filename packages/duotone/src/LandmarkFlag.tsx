...
const SvgLandmarkFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="landmark-flag_svg__fa-primary"
      d="M352 0c8.8 0 16 7.164 16 16v64c0 8.84-7.2 16-16 16h-80v32h192c17.7 0 32 14.3 32 32s-14.3 32-32 32H48c-17.67 0-32-14.3-32-32s14.33-32 32-32h192V16c0-8.836 7.2-16 16-16h96z"
    />
    <path
