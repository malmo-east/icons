...
const SvgSquareDownLeft = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
    <path
      className="square-down-left_svg__fa-primary"
      d="m331.5 216.4-73.54 73.54 45.25 45.25a15.995 15.995 0 0 1 3.471 17.44 15.988 15.988 0 0 1-14.78 9.875H133.5c-8.836 0-15.1-7.163-15.1-15.1v-158.4a15.97 15.97 0 0 1 9.877-14.78 15.982 15.982 0 0 1 17.44 3.469l45.25 45.25 73.54-73.54c9.373-9.371 24.57-9.371 33.94 0l33.94 33.94C340.9 191.8 340.9 207 331.5 216.4z"
    />
    <path
