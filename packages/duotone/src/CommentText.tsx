...
const SvgCommentText = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="comment-text_svg__fa-primary"
      d="M328 160H184c-13.2 0-24 10.7-24 23.1s10.8 24.9 24 24.9h48v104c0 13.25 10.75 23.1 23.1 23.1S280 325.3 280 312V208h48c13.3 0 24-10.8 24-24.9S341.3 160 328 160z"
    />
    <path
