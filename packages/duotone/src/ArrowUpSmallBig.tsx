...
const SvgArrowUpSmallBig = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="arrow-up-small-big_svg__fa-primary"
    ...
    />
    <path
      d="M480 256H320c-17.67 0-32 14.33-32 32v160c0 17.67 14.33 32 32 32h160c17.67 0 32-14.33 32-32V288c0-17.7-14.3-32-32-32zm-160-64h96c17.6 0 32-14.4 32-32V64c0-17.6-14.4-32-32-32h-96c-17.6 0-32 14.4-32 32v96c0 17.6 14.4 32 32 32z"
      style={{
        opacity: 0.4,
      }}
    />
