...
const SvgPenRuler = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="pen-ruler_svg__fa-primary"
      d="M378.7 19.32c25-24.998 65.6-24.998 90.6 0l23.4 23.43c25 24.99 25 65.55 0 90.55l-56.4 56.4-114-113.98 56.4-56.4zm35 192.98L158.8 467.1c-6.7 6.7-15 11.6-24.2 14.3L30.59 511.1c-8.38 2.4-17.4 0-23.56-7-6.163-5.3-8.5-14.3-6.106-22.7l29.726-104c2.61-9.2 7.51-17.5 14.24-24.2L299.7 98.34l114 113.96z"
    />
    <path
      d="m249.4 103.4-146 146L16 161.9c-18.745-18.7-18.745-49.1 0-67.84L94.06 16C112.8-2.745 143.2-2.745 161.9 16l19.8 19.76c-.3.29-.7.6-1 .93l-64 64.01c-6.3 6.2-6.3 16.4 0 22.6 6.2 6.3 16.4 6.3 22.6 0l64-63.99c.3-.32-.2-.66.9-1.01l45.2 45.1zm204.3 204.4c-.3.2-.7.6-1 .9l-64 64c-6.3 6.2-6.3 16.4 0 22.6 6.2 6.3 16.4 6.3 22.6 0l64-64c.3-1.2-.2-.7.9-1l19.8 19.8c18.7 18.7 18.7 49.1 0 67.8L417.9 496c-18.7 18.7-49.1 18.7-67.8 0l-87.5-87.4 146-146 45.1 45.2z"
      style={{
        opacity: 0.4,
      }}
    />
