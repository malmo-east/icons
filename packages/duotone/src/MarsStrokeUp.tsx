...
const SvgMarsStrokeUp = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" {...props}>
    <path
      className="mars-stroke-up_svg__fa-primary"
    ...
    />
    <path
      d="M256 335.1c0 35.35-28.65 63.1-64 63.1s-64-28.65-64-63.1 28.65-63.1 64-63.1 64 28.7 64 63.1z"
      style={{
        opacity: 0.4,
      }}
    />
