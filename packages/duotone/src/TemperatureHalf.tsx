...
const SvgTemperatureHalf = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" {...props}>
    <path
      className="temperature-half_svg__fa-primary"
      d="M176 322.9V208c0-8.75-7.25-16-16-16s-15.1 7.25-15.1 16l-.9 114.9c-18.62 6.625-32 24.25-32 45.13 0 26.5 21.5 48 48 48s48-21.5 48-48c0-20.93-13.4-38.53-32-45.13z"
    />
    <path
