...
const SvgWandMagicSparkles = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" {...props}>
    <path
      className="wand-magic-sparkles_svg__fa-primary"
      d="M148.5 497.9c-18.7 18.7-49.12 18.7-67.86 0l-34.58-34.6c-18.75-18.7-18.75-49.1 0-67.9L316.7 124.7l102.5 102.5-270.7 270.7z"
    />
    <path
