...
const SvgShieldPlus = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path
      className="shield-plus_svg__fa-primary"
      d="M360 255.1c0 13.26-10.74 23.1-23.1 23.1H280V336c0 13.26-10.74 23.1-23.1 23.1-13.27 0-23.1-10.74-23.1-23.1v-56.9H176c-13.27 0-23.1-10.74-23.1-23.1-.9-13.3 9.8-24 23.1-24h56v-56.9c0-13.26 10.74-23.1 23.1-23.1s24.9 10.7 24.9 23.1V232h56c13.3 0 24 10.7 24 23.1z"
    />
    <path
